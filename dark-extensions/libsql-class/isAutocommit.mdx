---
title: 'isAutocommit()'
description: "LibSQL PHP Extension method `isAutocommit()`"
---
...
- When autocommit mode is disabled, multiple SQL statements can be grouped into a single transaction using the [`transaction()`](/dark-extensions/libsql-class/transaction) method, allowing for more complex operations that require atomicity and consistency across multiple statements.
