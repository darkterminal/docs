...
<Frame>
  <img className="block dark:hidden" src="/images/libsql-php-extension-light.png" noZoom />
  <img className="hidden dark:block" src="/images/libsql-php-extension-dark.png" noZoom />
</Frame>
